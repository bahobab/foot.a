...
function FeaturedPostCard({ post }) {
  ...
  return (
    <div className='relative h-52'>
      ...
      <div className="absolute rounded-lg bg-center w-full h-52 bg-cover shaddow-md" style={{backgroundImage:`url('${post.coverImage.responsiveImage?.src}')`}}/>
      ...
      <div className="absolute flex flex-col rounded-lg p4 items-center justify-center w-full h-full">
        ...
        <p className="text-yellow-300 text-xl font-bold mb-4">{post.title}</p>
